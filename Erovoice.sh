...
rclone move ${TEMP_UNZIP_PATH} Onedrive:/ -P --transfers=20 --cache-chunk-size 32M --ignore-errors --no-traverse --create-empty-src-dirs --delete-empty-src-dirs --config "${RCLONE}"
#-----------------------------------------------------------------------
IFS=$OLD_IFS
exit 0
