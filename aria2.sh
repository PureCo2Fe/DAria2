...
APT_INSTALL(){
	...
	for i in p7zip-full p7zip-rar file rsync dos2unix cron wget curl ca-certificates findutils jq tar gzip dpkg stress-ng telnet net-tools libsodium23 openssl unzip net-tools
	do
    {
		apt-get install ${i} -y
    }&
